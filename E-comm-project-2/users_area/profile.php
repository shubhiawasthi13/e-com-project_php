...
<div class="row">
    <div class="col-md-2">
     ...
     <li class="nav-item bg-info">
        ...
        $select_user_image="select * from `user_table` where username='$username'";
        $result =mysqli_query($con, $select_user_image);
        ...
        <li class="nav-item ">
          <a class="nav-link text-light" href="profile.php?edit_account">Edit ccount</a>
        </li>
        <li class="nav-item ">
